...
const Contact = () => {
  return (
    <div
      name="contact"
      className="bg-[#00334d] w-full h-screen flex justify-center items-center p-4 text-gray-300"
    >
      <form
      ...
      >
        <div className="b-8">
          ...
          <p className="py-8">
            Submit the form or send me an email - <b>abhichandra03@gmail.com</b>
          </p>
        </div>
        <input
          type="text"
        ...
        <textarea
          name="Message"
          rows="10"
          className="bg-[#ccd6f6] text-gray-700 p-2 rounded-lg my-2 placeholder-gray-600"
          placeholder="Message"
        ></textarea>
